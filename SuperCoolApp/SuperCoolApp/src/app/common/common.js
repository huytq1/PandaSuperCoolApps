...
var Common = (function () {
    ...
    Common.convertToUtcTime = function (date) {
    ...
    Common.paymentTypeForDirectDebit = {
        cash: "Cash",
        cheque: "Cheque",
        paymentCard: "Payment Card",
        bankAccount: "Bank Account"
    };
    Common.directDebitErrorMessage = {
    ...
    Common.singlePaymentErrorMessages = {
